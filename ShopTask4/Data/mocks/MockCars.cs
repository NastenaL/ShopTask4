            ...
            get
            {
                return new List<Car> {
                    new Car { Name = "Tesla",
                              ...
                              Image = "https://s0.rbk.ru/v6_top_pics/media/img/5/74/755946359860745.jpg",
                              Price = 45000,
                              IsFavourite = true,
                              Avaitable = true,
                     ...
                     new Car { Name = "BMV X2",
                              ...
                              Image = "https://moneyinc.com/wp-content/uploads/2016/12/2018-BMW-X2.jpg",
                              Price = 12000,
                              IsFavourite = true,
                              Avaitable = true,
                      ...
                      new Car { Name = "BMV I3 Tera",
                              ...
                              Image = "https://ireland.apollo.olxcdn.com/v1/files/plfwn6yrytfa1-UA/image;s=1000x700",
                              Price = 25000,
                              IsFavourite = false,
                              Avaitable = true,
                              Category = categoryCars.AllCategories.First(),
